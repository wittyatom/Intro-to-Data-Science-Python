...
def answer_eight():
    ...
    m= Top15['Population'].max()
    ans=Top15[Top15['Population']==m]
...
def answer_nine():
    Top15 = answer_one()
    Top15['Population'] = Top15['Energy Supply']/Top15['Energy Supply per Capita']
    Top15['Citableper'] = Top15['Citable documents']/Top15['Population']
    ans = Top15['Citableper'].corr(Top15['Energy Supply per Capita'])
...
def plot9():
    ...
    Top15['Citableper'] = Top15['Citable documents'] / Top15['PopEst']
    Top15.plot(x='Citableper', y='Energy Supply per Capita', kind='scatter', xlim=[0, 0.0006])
